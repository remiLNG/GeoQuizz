...
async function testFlagGuesser() {
    ...
    */
    ...
    console.log("Statut de l'affichage d'un bouton 'question suivante' " + await driver.wait(until.elementLocated(By.className("button2")), 10000).isDisplayed());
    ...
    console.log("Statut de l'affichage d'un bouton 'question suivante' de la page 2 " + await driver.wait(until.elementLocated(By.className("button2")), 10000).isDisplayed());
    driver.findElement(By.id("retourmenu")).click();
    ...
    console.log("Statut de l'affichage d'un bouton 'question suivante' de la page 3 " + await driver.wait(until.elementLocated(By.className("button2")), 10000).isDisplayed());
    driver.findElement(By.id("retourmenu")).click();
